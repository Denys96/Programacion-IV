                ...
                <div class="card text-white" id="carMatricula">
                    ...
                    <div class="card-body text-dark">
                        <form method="post" @submit.prevent="guardarMatricula" @reset="nuevoMatricula">
                            ...
                            <div class="col col-md-4">
                                <input title="Ingrese el nombre del alumno" v-model="matricula.alumno" pattern="[A-Za-zñÑáéíóúü ]{3,75}" required type="text" class="form-control">
                                </div>
                            </div>
                            <div class="row p-1">
                                <div class="col col-md-3">Fecha de matricula:</div>
                            <div class="col">
                            ...
                            <div class="col col-md-4">
                                <input title="Ingrese el ciclo" v-model="matricula.ciclo" pattern="[A-ZA-ZÑÑÁÉÍÓÚÜ-0-9]{1,10}" required type="text" class="form-control">
                                </div>
                            </div>
                            <div class="row p-1">
    ...
    export default {
        ...
        methods:{
            ...
            eliminarMatricula(matricula){
                if( confirm(`Esta seguro de eliminar el matricula ${matricula.alumno}?`) ){
                            ...
                            .then(data=>{
                                ...
                                data.map(matricula=>{
                                    let store = this.abrirStore('matricula', 'readwrite'),
                                        query = store.put(matricula);
                                    query.onsuccess = e=>{
                                        console.log(`Matricula ${matricula.alumno} guardado`);
                                    };
                                    query.onerror = e=>{
